package top.pxczxn.platform.admin.controller.system;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import top.pxczxn.platform.common.result.Result;
import top.pxczxn.platform.system.config.SaTokenConfigLoader;
import top.pxczxn.platform.system.entity.SysConfigGroup;
import top.pxczxn.platform.mail.EmailService;
import top.pxczxn.platform.sms.SmsServiceFactory;
import top.pxczxn.platform.sms.entity.SmsLog;
import top.pxczxn.platform.sms.service.SmsLogService;
import top.pxczxn.platform.system.service.SysConfigGroupService;
import top.pxczxn.platform.system.helper.SystemConfigHelper;
import top.pxczxn.platform.pay.PayServiceFactory;
...
public class SysConfigGroupController {
    ...
    public Result<Map<String, String>> generateKeys() {
        try {
            Map<String, String> keyPair = top.pxczxn.platform.common.util.RsaUtils.generateKeyPair();
