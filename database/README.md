...
- 在线校验：V001 至 V016 各有一个 `database/verify` 脚本
...
关闭并脱敏待删除的支付、短信、微信和第三方集成；V016 删除对应菜单、授权、
无用配置组和已确认的脚手架示例数据。
