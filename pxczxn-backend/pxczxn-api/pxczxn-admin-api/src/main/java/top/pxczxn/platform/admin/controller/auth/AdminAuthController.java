package top.pxczxn.platform.admin.controller.auth;
...
import top.pxczxn.platform.auth.LoginStrategyFactory;
...
public class AdminAuthController {
    ...
    public Result<Map<String, Object>> captcha() {
        ...
        transientCodeStore.put(CAPTCHA_KEY + uuid, code.toLowerCase(), Duration.ofMinutes(5));
    ...
    public Result<Void> sendSmsCode(@RequestBody SmsCodeRequest request) {
        ...
        if (transientCodeStore.hasKey(limitKey)) {
        ...
        transientCodeStore.put(SMS_CODE_KEY + phone, code, Duration.ofMinutes(5));
        transientCodeStore.put(limitKey, "1", Duration.ofSeconds(60));
        return Result.ok();
    }
