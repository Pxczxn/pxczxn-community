...
// 站点配置（带默认值）
const siteName = computed(() => siteStore.siteName || '星语社区运营中心')
const siteDescription = computed(() => siteStore.siteDescription || '博客社区运营与治理中心')
const siteLogo = computed(() => siteStore.siteLogo)
const copyright = computed(() => siteStore.copyright || '版权所有 © 星语社区 2026')
