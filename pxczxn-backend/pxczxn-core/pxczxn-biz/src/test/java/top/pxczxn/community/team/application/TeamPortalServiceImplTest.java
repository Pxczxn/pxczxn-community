...
class TeamPortalServiceImplTest {
    ...
    private SeriesArticleMapper seriesArticleMapper;
    ...
    void setUp() {
        ...
        seriesArticleMapper = mock(SeriesArticleMapper.class);
    ...
    void myTeamsEnrichesMembershipsWithCountersAndPermissions() {
        ...
        when(seriesMapper.countByBlogs(List.of(10L))).thenReturn(List.of(countRow(10L, 4)));
    ...
    void dashboardReturnsStatsRecentArticlesTodosAndActivities() {
        ...
        when(seriesMapper.countByBlogs(List.of(10L))).thenReturn(List.of(countRow(10L, 3)));
        ...
        when(seriesMapper.countByBlogAndReviewStatus(10L, "PENDING_REVIEW")).thenReturn(1);
    ...
    void activitiesCapLimitAndResolveActorNames() {
        ...
        event.setEventType("SERIES_CREATED"); event.setTargetType("SERIES"); event.setTargetId(7L);
    ...
    void teamArticlesCarrySeriesMembership() {
        ...
        Series series = new Series(); series.setId(77L); series.setTitle("Spring Boot 实战");
    ...
    private static TeamCountRow countRow(Long groupId, int total) { TeamCountRow row = new TeamCountRow(); row.setTeamId(groupId); row.setTotal(total); return row; }
